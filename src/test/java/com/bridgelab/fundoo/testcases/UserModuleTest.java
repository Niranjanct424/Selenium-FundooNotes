...
public class UserModuleTest {
	...
	public void testLogin(String userId, String password, String isLoginExpectedToBeSuccessfulString)
...
//		return ExcelReadUtil.readExcelInto2DArray("./src/test/resources/register-data.xlsx", "Sheet1", 5);
		return new String[][] {
			{"Niranjan","niranjangyadav124@gmail.com","niranjan@55","8880846463"},
